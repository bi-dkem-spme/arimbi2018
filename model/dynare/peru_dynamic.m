...
T181 = params(42)/(params(15)*params(39));
T202 = 1/(params(15)*params(39));
lhs =y(19)-y(20);
...
residual(14)= lhs-rhs;
lhs =y(26);
rhs =(y(33)-y(20))*(-params(16))+((1-params(14))*(params(3)*y(21)+y(28)*params(18))+params(14)*params(19)*params(20)*(y(38)*params(16)+y(43)))/(params(14)*params(19)*params(20)+(1-params(14))*(params(3)+params(18)));
residual(15)= lhs-rhs;
lhs =y(26)+y(33)-y(20);
rhs =T181*(y(20)+params(21)*(y(10)+y(4)-y(20))-y(36)-params(21)*(y(23)+y(36)-y(20))+params(22)*(y(36)+y(37)-y(20)))+T202*(y(21)*params(3)*params(8)+params(5)*params(7)*(y(19)-y(20)+y(40)));
residual(16)= lhs-rhs;
lhs =y(37);
rhs =y(44)+y(55)-y(35);
residual(17)= lhs-rhs;
...
if nargout >= 2,
  ...
  g1(14,42)=1;
  g1(15,20)=(-params(16));
  g1(15,21)=(-(params(3)*(1-params(14))/(params(14)*params(19)*params(20)+(1-params(14))*(params(3)+params(18)))));
  g1(15,26)=1;
  g1(15,28)=(-((1-params(14))*params(18)/(params(14)*params(19)*params(20)+(1-params(14))*(params(3)+params(18)))));
  g1(15,33)=params(16);
  g1(15,38)=(-(params(16)*params(14)*params(19)*params(20)/(params(14)*params(19)*params(20)+(1-params(14))*(params(3)+params(18)))));
  g1(15,43)=(-(params(14)*params(19)*params(20)/(params(14)*params(19)*params(20)+(1-params(14))*(params(3)+params(18)))));
  g1(16,19)=(-(T202*params(5)*params(7)));
  g1(16,20)=(-1)-(T181*(1-params(21)-(-params(21))-params(22))+T202*(-(params(5)*params(7))));
  g1(16,21)=(-(T202*params(3)*params(8)));
  g1(16,4)=(-(T181*params(21)));
  g1(16,23)=(-(T181*(-params(21))));
  g1(16,26)=1;
  g1(16,33)=1;
  g1(16,10)=(-(T181*params(21)));
  g1(16,36)=(-(T181*(params(22)+(-1)-params(21))));
  g1(16,37)=(-(T181*params(22)));
  g1(16,40)=(-(T202*params(5)*params(7)));
  g1(17,35)=1;
  g1(17,55)=(-1);
  g1(17,37)=1;
  g1(17,44)=(-1);
